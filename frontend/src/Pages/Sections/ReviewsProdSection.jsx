...
function Reviews() {
    ...
    return (
        <div className="mx-4 sm:mx-8 lg:mx-[140px] pt-[50px]">
            {/* Reviews Title */}
            <span className="text-center lg:text-left block lg:inline-block font-bold text-[20px] sm:text-[24px] lg:text-[26px]">
                All Reviews <span className="font-semibold opacity-60 text-[12px] sm:text-[14px]">(451)</span>
            </span>
            ...
            {/* Load More Button */}
            <div className="cursor-pointer duration-500 hover:border-black font-normal mt-[50px] text-[16px] align-middle w-[218px] h-[58px] border-2 rounded-3xl flex m-auto justify-center items-center mb-[-80px]">
